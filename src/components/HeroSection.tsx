  ...
  return (
    <section className="relative w-screen min-h-[100svh] overflow-hidden bg-[#F8F4E6]">
      ...
      <div className="absolute bottom-24 w-full flex justify-center gap-4 z-[50] pointer-events-auto">
        <button onClick={() => alert("Pre-order modal coming soon!")} className="px-8 py-4 bg-black text-white font-bold tracking-widest text-sm rounded-full shadow-lg hover:scale-105 transition-transform">
          PRE-ORDER NOW
        </button>
      </div>
    </section>
