  ...
  return (
    <nav className="absolute top-0 left-0 w-full p-8 flex justify-between items-center z-[100] pointer-events-auto">
      ...
      <div className="flex gap-8 text-black text-sm font-medium tracking-widest">
        ...
        <button className="outline-none focus:outline-none focus-visible:outline focus-visible:outline-1 focus-visible:outline-black/35 focus-visible:outline-offset-4 hover:opacity-70 transition-opacity">CART (0)</button>
      </div>
    </nav>
  );
}
